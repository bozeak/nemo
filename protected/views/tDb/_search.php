...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'nr_etaje'); ?>
		<?php echo $form->textField($model,'nr_etaje',array('size'=>2,'maxlength'=>2)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'suprafata'); ?>
		<?php echo $form->textField($model,'suprafata',array('size'=>5,'maxlength'=>5)); ?>
	</div>
